...
import profilePicture from '../assests/ProfileImageABT.jpg'; // Update with the correct path to your image
import hobby1 from '../assests/hobby1.jpg'; // Replace with your actual image paths
  ...
  return (
    <div className="about-page">
      <section className="about-section">
        ...
        <p>My journey began in the vast fields of Electronics and Telecommunication, where my bachelor's degree from Mumbai University was not just a learning phase but a cornerstone for my future endeavors.
...
<p>My career path has been a testament to a relentless pursuit of excellence, marked by a tenure at Tech Mahindra where I've been honored with accolades like the ACE Award. But my identity transcends the bounds of the professional sphere.</p>
...
<p>A fun-loving spirit, a happy demeanor, and a propensity to lend a helping hand define my personal journey. For me, every sunrise heralds new opportunities to grow, to give, and to inspire. It's this rich tapestry of diverse interests and unyielding drive that shapes my narrative—both as a distinguished professional and an impassioned human</p>
        </div>
